...
Finally we can draw our leafdown map. The specified arguments are internally 
handed over to the `addPolygons` of `leaflet` such that we can use all this great 
